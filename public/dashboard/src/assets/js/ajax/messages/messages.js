$(document).ready(function($){
    ...
    {
        const messagesGetAllUrl= $('#messagesGetAllUrl').val();
        var messagesGetAllTable = $('#messages-table').DataTable( {
            ...
            "columns": [
                {data:'id', name:'id'},
                {data:'customerPhone', name:'customerPhone', orderable:false, searchable:false},
    ...
    $("#btn-search-sales").click(function(event) {
        ...
        $('#messages-table').DataTable().clear().destroy();
