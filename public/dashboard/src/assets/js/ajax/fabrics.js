$(document).ready(function($){
    ...
    var table = $('#fabrics-table').DataTable( {
    ...
    function getOne(showUrl)
    {
        $.ajax({
            ...
            .done(function (data) {
                $('#name_edit').val(data.fabric.name);
                $('#price_for_one_fabric_edit').val(data.fabric.price_for_one_fabric);
                $('#stock_edit').val(data.fabric.stock);
                $('#id').val(data.fabric.id);
                $('#uuid').val(data.fabric.uuid);
            })
            .fail(function (res) {
                Snackbar.show({
                    text: res.responseJSON.message,
