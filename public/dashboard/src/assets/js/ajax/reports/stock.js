$(document).ready(function($){
    ...
    {
        const stockGetAllUrl= $('#stockGetAllUrl').val();
        var stockGetAllTable = $('#stock-report-table').DataTable( {
            ...
            "columns": [
                ...
                {data:'clothsSales', name:'clothsSales'},
                {data:'returnedCloths', name:'returnedCloths'},
                {data:'netCloths', name:'netCloths', orderable:false, searchable:false},
            ],
            "columnDefs": [
                {
                    "targets": 'no-sort',
