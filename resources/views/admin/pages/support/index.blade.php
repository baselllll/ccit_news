        ...
        <!-- BREADCRUMB -->
            <div class="page-meta">
                <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item fw-bolder">@lang('dashboard.support')</li>
                    </ol>
                </nav>
            </div>
            <!-- /BREADCRUMB -->
            <div class="row layout-top-spacing">
                <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                    <div class="widget-content widget-content-area br-8" style="padding: 23px;">
                        <table id="support" class="table dt-table-hover" style="width:100%">
                            <thead>
                            <tr>
                                <th>@lang('dashboard.support_name')</th>
                                <th>@lang('dashboard.support_description')</th>
                                <th>@lang('dashboard.support_image')</th>
...
@push('js')
    ...
    <script src="{{ asset('dashboard/src/assets/js/ajax/support.js')}}"></script>
@endpush
