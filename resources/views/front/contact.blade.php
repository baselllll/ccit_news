...
<head>
    ...
    <title>Contact Us || Blogar - Personal Blog Template</title>
                ...
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col-xl-6 d-none d-xl-block">
                                ...
                                <ul class="mainmenu">
                                    <li class="menu-item-has-children"><a href="#">Home</a>
                                        <ul class="axil-submenu">
                                            <li>
                                                <a class="hover-flip-item-wrapper" href="index.blade.php">
                        ...
                        <span data-text="Author Page">Author Page</span>
                                            ...
                                            <li>
                                                <a class="hover-flip-item-wrapper" href="about.blade.php">
                                                    <span class="hover-flip-item">
                        <span data-text="About Page">About Page</span>
                                            ...
                                            <li>
                                                <a class="hover-flip-item-wrapper" href="contact.blade.php">
                                                    <span class="hover-flip-item">
        ...
        <div class="popup-mobilemenu-area">
            <div class="inner">
                ...
                <ul class="mainmenu">
                    <li class="menu-item-has-children"><a href="#">Home</a>
                        <ul class="axil-submenu">
                            <li><a href="index.blade.php">Home Default</a></li>
                    ...
                    <li class="menu-item-has-children"><a href="#">Pages</a>
                        <ul class="axil-submenu">
                            ...
                            <li><a href="about.blade.php">About Page</a></li>
